...
//   useEffect(() => {
//     const response = dataFetchService.getDashboardView()
//     setLoading(true)
//     response.then((res) => {
//       setData(res.data)
//       console.log(res)
...
//                     </svg>
//                     <div>
//                         <h5 className="text-xl text-gray-600 text-center">Payment Requests</h5>
//                         <div className="mt-2 flex justify-center gap-4">
//                             <h3 className="text-3xl font-bold text-gray-700">{
//                             new Intl.NumberFormat().format(data.payments_requests_current_month_amount)
//                             }</h3>
...
//                                 </svg>
//                                 <span>{
//                             new Intl.NumberFormat().format(data.payments_requests_current_month_amount/data.payments_requests_last_month_amount*100-100)
//                             }%</span>
//                             </div>
//                         </div>
//                         <span className="block text-center text-gray-500">Compared to last week {
//                             new Intl.NumberFormat().format(data.payments_requests_last_month_amount)
//                             }</span>
//                     </div>
//                     <table className="w-full text-gray-600">
//                         <tbody>
//                             <tr>
//                                 <td className="py-2">No. of Requests</td>
//                                 <td className="text-gray-500">
//                                     {new Intl.NumberFormat().format(data.payments_requests_current_month_count)}
//                                 </td>
//                                 <td>
...
//                                 <td className="text-gray-500">{
//                             new Intl.NumberFormat().format(data.payments_requests_last_month_count)
//                                 }</td>
//                                 <td>
//                                     <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
//                                         <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
...
//                     <h5 className="text-xl text-gray-700">Payments</h5>
//                     <div className="my-8">
//                         <h1 className="text-5xl font-bold text-gray-800">{new Intl.NumberFormat().format(data.payments_current_month_amount)}</h1>
//                         <span className="text-gray-500">Compared to last month {
//                             new Intl.NumberFormat().format(data.payments_last_month_amount)
//                         }</span>
//                     </div>
...
//                         <tbody>
//                             <tr>
//                                 <td className="py-2">Payments this month</td>
//                                 <td className="text-gray-500">{new Intl.NumberFormat().format(data.payments_current_month_count)}</td>
//                                 <td>
//                                     <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
//                                         <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
//                                         <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="#e4e4f2"/>
...
//                             <tr>
//                                 <td className="py-2">Last Month</td>
//                                 <td className="text-gray-500">{new Intl.NumberFormat().format(data.payments_last_month_count)}</td>
//                                 <td>
//                                     <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
//                                         <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
//                                         <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="#e4e4f2"/>
...
//                     </svg>
//                     <div className="mt-6">
//                         <h5 className="text-xl text-gray-700 text-center">Today</h5>
//                         <div className="mt-2 flex justify-center gap-4">
//                             <h3 className="text-3xl font-bold text-gray-700">{new Intl.NumberFormat().format(data.payments_today_amount)}</h3>
//                             <div className="flex items-end gap-1 text-green-500">
//                                 <svg className="w-3" viewBox="0 0 12 15" fill="none" xmlns="http://www.w3.org/2000/svg">
//                                     <path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor"/>
//                                 </svg>
...
//                             </div>
//                         </div>
//                         <span className="block text-center text-gray-500">Compared to yesterday {new Intl.NumberFormat().format(data.payments_yesterday_amount)}</span>
//                     </div>
//                     <table className="mt-6 -mb-2 w-full text-gray-600">
//                         <tbody>
//                             <tr>
//                                 <td className="py-2">No. of Requests</td>
//                                 <td className="text-gray-500">{new Intl.NumberFormat().format(data.payment_requests_today_amount)}</td>
//                                 <td>
//                                     <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
//                                         <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
//                                         <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="#e4e4f2"/>
...
//                             </tr>
//                             <tr>
//                                 <td className="py-2">No.of Payments</td>
//                                 <td className="text-gray-500">{new Intl.NumberFormat().format(data.payments_today_count)}</td>
//                                 <td>
//                                     <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
//                                         <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
//                                         <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="#e4e4f2"/>
